...
internal class LambdaBasedCommandType : ICommandType
{
    ...
    internal LambdaBasedCommandType(LambdaBasedCommandMetadata commandMetadata, IEnumerable<LambdaBasedCommandOption> options, Func<CommandExecutionContext, CancellationToken, Task<int>> executeCommand)
    {
        _options = options;
